...
export function DataTableToolbar<TData>({
  ...
  const [filterValue, setFilterBy] = React.useState(filterBy || 'customerUserLink.user.name')
  ...
  const placeholder = React.useMemo(() => {
    switch (filterValue) {
      case 'customerUserLink.user.name':
        return 'Nome...'
                  ...
                  <Select value={filterValue} onValueChange={setFilterBy}>
                    ...
                    <SelectContent>
                      <SelectGroup>
                        ...
                        <SelectItem value="customerUserLink.user.name">Nome</SelectItem>
