...
import { NewCustomerType, newCustomerSchema } from './schema'
...
export function NewCustomerForm() {
  ...
  const handleSubmitWithTransition = async (formData: NewCustomerType) => {
    startTransition(() => {
      handleSubmit(formData)
    })
  }

  const handleSubmit = async (data: NewCustomerType) => {
    const toasterId = 'creating-new-customer'

    try {
      toast.loading('Criando novo cliente...', {
        id: toasterId,
      })
